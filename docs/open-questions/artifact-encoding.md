...
**Status:** RESOLVED in da-run2 (2026-07-18) as option B: both the artifact collector and the snapshot reader share one `read_utf8` helper that refuses invalid bytes with the file and offset named. Silent corruption is now a loud typed error.
